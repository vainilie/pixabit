...
default_theme_dict = {
    ...
    "rp_overlay": "  #26233a",
    "field": "dim",
    # Style for field names in reviews
}

custom_theme: Optional[Theme] = None
console: Console
print_func = builtins.print
# Default to standard print
...
if theme_file_path.exists():
    try:
        ...
        # Use console.print if theme loaded
        ...
        custom_theme = Theme(default_theme_dict)
        # Use basic dict fallback
        console = Console(theme=custom_theme)
else:
...
install_traceback(
    console=console,
    show_locals=False,
    # Set show_locals=True for more detailed debugging
)
...
__all__ = [
    "console",
    "print_func",
    # Keep original name for clarity if needed elsewhere
    "print",
    # Export the wrapper function as 'print'
    "Confirm",
    "IntPrompt",
    "Prompt",
    "Table",
