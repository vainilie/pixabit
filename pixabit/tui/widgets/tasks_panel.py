...
class TasksPanel(Widget):
    ...
    async def sort_reverse(self, sort_type: str):
    ...
    async def action_sort_by_average_time(self) -> None:
    ...
    async def action_sort_by_last_name(self) -> None:
    ...
    async def action_sort_by_country(self) -> None:
    ...
    async def action_sort_by_columns(self) -> None:
...
class MyApp(App):
    def compose(self) -> ComposeResult:
        """Componer los widgets dentro de la aplicación."""
        yield TasksPanel()
