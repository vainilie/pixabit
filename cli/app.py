...
# --- Rich and Display ---
try:
    from pixabit.helpers._rich import (  # Use .. to import from parent utils
        BarColumn,
        Confirm,
        IntPrompt,
        Live,
...
class CliApp:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.processor: TaskProcessor | None = None  # Sync processor
        ...
        self.all_challenges_cache: list[dict[str, Any]] | None = (
    ...
    def _fetch_challenges_cached(self) -> list[dict[str, Any]] | None:
    ...
    # FUNC: _display_stats
    def _display_stats(self) -> Panel | None:
    ...
    def _display_broken_tasks(
        self, challenge_id_filter: str | None = None
    ) -> list[dict[str, Any]]:
