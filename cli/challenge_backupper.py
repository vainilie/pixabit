...
try:
    ...
    from pixabit.helpers._json_helper import save_json  # Use shared save utility
    from pixabit.helpers._rich import console, print  # Use themed display
except ImportError:
    # Fallback imports
    import builtins
...
class ChallengeBackupper:
    ...
    def _group_tasks_by_challenge(
        self, tasks: list[dict[str, Any]] | None
